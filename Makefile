...
VERSION_PACKAGE=github.com/opencreate/miniblog/pkg/version
## 定义 VERSION 语义化版本号
...
add-copyright: # 添加版权头信息.
	@addlicense -v -f $(ROOT_DIR)/script/boilerplate.txt $(ROOT_DIR) --skip-dirs=third_party,vendor,$(OUTPUT_DIR)
